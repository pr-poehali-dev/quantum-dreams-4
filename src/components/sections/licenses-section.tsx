...
const licenses = [
  {
    ...
    issuer: "Министерство строительства РФ",
    number: "СРО-С-057-02052016",
    direction: "left",
  },
  {
    title: "Лицензия ФСБ на монтаж ИТСО",
    issuer: "Федеральная служба безопасности РФ",
    number: "ЛСЗ №0123456",
    direction: "right",
  },
  {
